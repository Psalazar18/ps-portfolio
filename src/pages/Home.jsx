            ...
            <main className="main">
                <div className="container">
                    <div className="main-text text-end">
                        ...
                        <p>Soy una desarrolladora web con ojo para los detalles y una gran curiosidad por cómo hacer que las ideas cobren vida en la pantalla. Me apasiona crear experiencias digitales que conecten, sorprendan y funcionen. Pero no solo vivo en el mundo del código: también traigo conmigo experiencia en atención al cliente, ventas y otras áreas que me han enseñado a trabajar en equipo, resolver problemas y adaptarme rápido.
